...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        'SmartWiki\Events\SomeEvent' => [
            'SmartWiki\Listeners\SomeEventListener',
        ],
        'event.foo' => [
            'SmartWiki\Listeners\SomeOtherEventListener@handle_foo',
        ],
        'event.*' => [
            'SmartWiki\Listeners\SomeOtherEventListener@handle_bar',
        ],
    	'Illuminate\Database\Events\QueryExecuted' => [
    		'SmartWiki\Listeners\SqlListener',
    	],
    ];
    
    protected $subscribe = [
    	'SmartWiki\Listeners\SomeEventSubscriber',
    ];
